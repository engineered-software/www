import { r as render, L as LEGACY_PROPS, g as get, f as flush_sync, d as define_property, i as init_operations, a as get_first_child, H as HYDRATION_START, b as get_next_sibling, c as HYDRATION_ERROR, e as HYDRATION_END, h as hydration_failed, j as clear_text_content, k as increment_write_version, l as array_from, m as component_root, D as DIRTY, s as set_signal_status, C as CLEAN, U as UNOWNED, n as DERIVED, o as schedule_effect, p as is_passive_event, q as active_reaction, u as untracking, t as is_runes, B as BLOCK_EFFECT, v as derived_sources, w as state_unsafe_mutation, x as active_effect, y as BRANCH_EFFECT, R as ROOT_EFFECT, z as untracked_writes, A as set_untracked_writes, M as MAYBE_DIRTY, E as create_text, F as branch, G as push, I as setContext, J as pop, K as push$1, N as component_context, O as pop$1, P as DEV } from './chunks/index2-BDI6ceGZ.js';
...
import { i as is_primitive, g as get_type, D as DevalueError, a as is_plain_object, s as stringify_string, e as escaped, b as stringify } from './chunks/stringify-Djm7PJzE.js';
import { s as safe_equals, e as equals, d as decode_pathname, a as decode_params, n as normalize_path, b as disable_search, r as resolve, m as make_trackable, c as readable, w as writable } from './chunks/exports-BX5H4HJi.js';
import { a as all_registered_events, r as root_event_handles, h as handle_event_propagation } from './chunks/events-Dpdf-Hjr.js';
...
async function get_hooks() {
  ...
  let handleError;
  let init;
  ({ handle, handleFetch, handleError, init } = await import('./chunks/hooks.server-DQiQxTGM.js'));
  let reroute;
  let transport;
  ({ reroute, transport } = await import('./chunks/hooks-C4yQsH84.js'));
  return {
    handle,
    handleFetch,
    handleError,
